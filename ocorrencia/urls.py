...
from .views import ListOcorrenciaView, CreateOcorrenciaView, UpdateOcorrenciaView, DetailOcorrenciaView, ListPassagemPlantaoView, CreatePassagemPlantaoView
...
urlpatterns = [
    ...
    path('<int:id>/update/', UpdateOcorrenciaView.as_view(), name='upd_ocorrencia'),
