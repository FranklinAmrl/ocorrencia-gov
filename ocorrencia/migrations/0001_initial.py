# Generated by Django 4.0.1 on 2022-07-05 00:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_reset_password', models.CharField(blank=True, max_length=200, null=True)),
                ('token_data', models.DateTimeField(blank=True, null=True)),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Ativo'), (2, 'Inativo'), (3, 'Não Verificado')], default=3)),
                ('fone', models.CharField(max_length=15, verbose_name='Telefone')),
                ('birth_date', models.DateField()),
                ('genre', models.PositiveSmallIntegerField(choices=[(1, 'Masculino'), (2, 'Feminino'), (3, 'Outros'), (4, 'Não Informar')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordenadaX', models.CharField(blank=True, max_length=255, null=True, verbose_name='Coordenadas X')),
                ('coordenadaY', models.CharField(blank=True, max_length=255, null=True, verbose_name='Coordenadas Y')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.PositiveSmallIntegerField(choices=[(1, 'Administrador'), (2, 'Gestor'), (3, 'Inspetor'), (4, 'Notificante')])),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='ocorrencia.management')),
            ],
            options={
                'verbose_name': 'user',
